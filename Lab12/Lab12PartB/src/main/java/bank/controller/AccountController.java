...
import bank.dto.request.TransferFundsRequest;
...
public class AccountController {
    ...
    public void transferFunds(
            ...
            @RequestBody TransferFundsRequest transferFundsRequest
    ) {
        accountService.transferFunds(
                fromAccountNumber,
                transferFundsRequest.getToAccountNumber(),
                transferFundsRequest.getAmount(),
                transferFundsRequest.getDescription()
        );
    }
